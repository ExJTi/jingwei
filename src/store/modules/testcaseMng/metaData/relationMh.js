// 点击创建用例，弹出全新创建 + 模板创建的选择页面
// 点击详情页面，展示执行历史记录和修改历史记录
export default {
  refreshInterval: 3000,
  viewType: 'table',
  module: 'testcaseMng/modifyHistory',
  relationSearch: true,
  params: {
    isDelete: false
  },
  ...
  view: {
    columns: [
      ...
      {
        props: {
          label: 'testcaseMng.operator', // 显示的标题
      ...
      {
        props: {
          label: 'testcaseMng.operatorType',
          prop: 'userType',
          width: 100
        },
        dataType: 'enum'
